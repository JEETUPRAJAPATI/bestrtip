...
<div class="container-fluid">
    <div class="pt-5 row">
        <div class="col-lg-8 col-sm-12 col-md-12">
            <h1 class="tour-title">Vintage Double Decker Bus Tour & Thames River Cruise</h1>
    ...
    <div id="carouselExampleIndicators" class="carousel carousel-theme slide">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="https://images.unsplash.com/photo-1501785888041-af3ef285b470" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="https://images.unsplash.com/photo-1418065460487-3e41a6c84dc5" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="https://images.unsplash.com/photo-1437209484568-e63b90a34f8b" class="d-block w-100" alt="...">
          </div>
        </div>
...
<div class="thumbnail-container grid grid-cols-3 sm:grid-cols-4 md:flex md:flex-wrap gap-2 md:gap-3 mt-4">
    <img src="https://images.unsplash.com/photo-1501785888041-af3ef285b470" alt="Thumbnail 1"
        class="thumbnail w-20 h-20 object-cover rounded-md cursor-pointer">
    <img src="https://images.unsplash.com/photo-1418065460487-3e41a6c84dc5" alt="Thumbnail 2"
        class="thumbnail w-20 h-20 object-cover rounded-md cursor-pointer">
    <img src="https://images.unsplash.com/photo-1437209484568-e63b90a34f8b" alt="Thumbnail 3"
        class="thumbnail w-20 h-20 object-cover rounded-md cursor-pointer">
    <img src="https://images.unsplash.com/photo-1469474968028-56623f02e42e" alt="Thumbnail 4"
        class="thumbnail w-20 h-20 object-cover rounded-md cursor-pointer">
    <img src="https://images.unsplash.com/photo-1470770903676-69b98201ea1c" alt="Thumbnail 5"
        class="thumbnail w-20 h-20 object-cover rounded-md cursor-pointer">
</div>
...
<div class="overview-content bg-white">
    ...
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
        labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
        laboris Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
    ...
    <!-- Itinerary Container -->
    <div class="d-flex flex-column py-1 mt-5 itenary-container bg-white">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="d-flex flex-column text-xl font-weight-bold text-dark">
                        <div>Day 5 Monday</div>
                        <div class="mt-2">03-04-2025</div>
                    </div>
                </div>
                <div class="col-md-8">
                    ...
                    <p class="text-base font-weight-semibold text-muted">
                        The tour was very well organised. One minus is that you get completely bombarded with
                        information. You
                        also have to stand up for too long at the private entrance to the Tower of London, which leads
                        to a lack
                        of time later. Lunch was the same, too stress, the quality was great but you couldn't enjoy it.
                        I'd like
                        to ask the organisers: please
                    </p>
                </div>
            </div>
        </div>

        <!-- Itinerary Section 2 - Improved with consistent grid layout -->
        <div class="d-flex flex-column pt-5 px-3 pb-4 itenary border-bottom">
            <div class="row">
                <div class="col-md-4">
                    <div class="d-flex flex-column text-xl font-weight-bold text-dark">
                        <div>Day 5 Monday</div>
        ...
        <!-- Itinerary Section 3 - Already has good structure but standardized with others -->
        <div class="pt-5 px-3 pb-4 bg-white border-bottom">
            <div class="row">
                <div class="col-md-4">
                    <div class="d-flex flex-column text-xl font-weight-bold text-dark">
                        <div>Day 5 Monday</div>
        ...
        <!-- Itinerary Section 4 - Improved with consistent structure -->
        <div class="d-flex flex-column pt-4 px-3 pb-4 mb-0 itenary mb-4">
            <div class="row">
                <div class="col-md-4">
                    <div class="d-flex flex-column text-xl font-weight-bold text-dark">
                        <div>Day 5 Monday</div>
    ...
    'https://images.unsplash.com/photo-1660557989725-f511e9fa6267?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8aG90ZWwlMjBsb2JieXxlbnwwfHwwfHx8MA%3D%3D'
            ...
            <div class="w-full md:w-1/2 md:pl-4 md:mt-0">
                <div class="flex justify-between">
                    <h3 class="text-lg md:text-xl font-bold text-gray-800">The Grand Paris Hotel
    ...
    <div class="bg-white summary-details">
        <div class="detail-row">
            ...
            <div class="w-100">
                ...
                <p class="detail-value">6 Nights 6 Days</p>
            </div>
        </div>
        ...
        <div class="detail-row">
            ...
            <div class="w-100">
                ...
                <p class="detail-value">10 Dec 2025</p>
            </div>
        </div>
