                      ...
                      <td class="border-right-dark">
                        <div class="dropdown pos-relative">
                          ...
                          <div class="dropdown-menu custom-dd-menu">
                            ...
                            <a class="dropdown-item" href="duplicate_package.php?crm=<?php echo encryptId($row['id']); ?>" onClick="return confirm('Are you sure you want to duplicate this record?')">
                              <i class="bx bx-copy me-1"></i> Duplicate Package
                            </a>
                          </div>
                        </div>
                      </td>
