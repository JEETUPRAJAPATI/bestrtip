...
$blogs = $db->arraybuilder()->paginate('carlist', $page, $select);
...
<div class="layout-page">
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select class="form-select" name="filter_col">
                                    <option value="name" <?= $filter_col == 'name' ? 'selected' : '' ?>>Car Name</option>
                                </select>
                            </div>
                            <div class="col-md-4">
            ...
            <div class="row">
                <div class="col">
                    <h4 class="py-3 mb-4">View Car List</h4>
                </div>
                <div class="col-auto">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (!empty($row['image'])) : ?>
                                                    <img src="<?php echo $row['image']; ?>" alt="Flight Logo" width="100">
                                                <?php else : ?>
                                                    N/A
                                                <?php endif; ?>
                                            </td>
                                            ...
                                            <td class="border-right-dark">
                                                <div class="dropdown pos-relative">
                                                    ...
                                                    <div class="dropdown-menu custom-dd-menu">
                                                        <a href="add-car.php?id=<?= encryptId($row['id']) ?>" class="dropdown-item">Edit</a>
                                                        <a href="delete-car.php?id=<?= encryptId($row['id']) ?>" class="dropdown-item" onclick="return confirm('Are you sure?')">Delete</a>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="6" class="text-center">No Car found</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    ...
                    <!-- Pagination -->
                    <div class="text-end">
                        <?= paginationLinks($page, $total_pages, 'view-car.php') ?>
                    </div>
                </div>
            </div>
        </div>
