        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
              <!-- Content -->
                ...
                <h4 class="py-3 mb-4">Add Location</h4>
                        ...
                        <div class="card-body">
                          <form>
                            <div class="mb-3">
                              ...
                              <input type="text" name="location" class="form-control" placeholder="Please enter location name" value="<?php echo isset($data['location'])?$data['location']:'' ?>" />
