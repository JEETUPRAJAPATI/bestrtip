...
<div class="layout-page">
  ...
  <div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <h4 class="py-3 mb-4">View Category List</h4>
                ...
                <table class="table">
                  <thead>
                    <tr class="text-nowrap bg-dark align-middle">
                      <th class="text-white border-right-white">Category ID</th>
                      <th class="text-white border-right-white">Category Name</th>
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="border-right-dark"><a href="add-category.php?id=<?php echo encryptId($row['id']); ?>">Edit Details</a></td>
                      </tr>
                    <?php
                      $k++;
                    endforeach;
