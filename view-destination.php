...
$rows = $db->arraybuilder()->paginate('destination', $page, $select);
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="border-right-dark"><a href="add-destination.php?id=<?php echo encryptId($row['id']); ?>">Edit Details</a></td>
                      </tr>
                    <?php
                      $k++;
                    endforeach;
