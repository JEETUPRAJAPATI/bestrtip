...
if ($location) {
    ...
    if (isset($_GET['id']) && !empty($_GET['id'])) {
        ...
        $id = $db->update('traveling_from',  $data);
    } else {
        $id = $db->insert('traveling_from',  $data);
    }
                        ...
                        <div class="card-body">
                            <form>
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="location" class="form-control" placeholder="Please enter from location name" value="<?php echo isset($data['name']) ? $data['name'] : '' ?>" />
