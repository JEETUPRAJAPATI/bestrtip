...
$rows = $db->arraybuilder()->paginate('traveling_from', $page, $select);
                                ...
                                <table class="table">
                                    <thead>
                                        <tr class="text-nowrap bg-dark align-middle">
                                            <th class="text-white border-right-white">Traveling from ID</th>
                                            <th class="text-white border-right-white">From Name</th>
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="border-right-dark"><a href="add-from.php?id=<?php echo encryptId($row['id']); ?>">Edit Details</a></td>
                                            </tr>
                                        <?php
                                            $k++;
                                        endforeach;
