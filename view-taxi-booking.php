...
$db = getDbInstance();
$select = array('id', 'package_code', 'package_name', 'duration',  'status', 'created_at', 'updated_at');
...
$rows = $db->arraybuilder()->paginate('taxi', $page, $select);
...
<div class="layout-page">
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col">
                <h4 class="py-3 mb-4">View All Taxi</h4>
            </div>
            <div class="col-auto">
                <a href="add-taxi-booking.php" class="btn btn-primary">Add Taxi</a>
            </div>
        </div>
                                            ...
                                            <td class="border-right-dark">
                                                <div class="dropdown pos-relative">
                                                    ...
                                                    <div class="dropdown-menu custom-dd-menu">
                                                        <a class="dropdown-item" href="add-taxi-booking.php?crm=<?php echo encryptId($row['id']); ?>"><i class="bx bx-edit-alt me-1"></i> Edit taxi</a>
                                                        <a class="dropdown-item" href="delete-taxi.php?crm=<?php echo encryptId($row['id']); ?>" onClick="return confirm('Are you sure you want to delete this record?')"><i class="bx bx-trash me-1"></i> Delete taxi</a>
                                                        <a class="dropdown-item" href="duplicate-taxi.php?crm=<?php echo encryptId($row['id']); ?>" onClick="return confirm('Are you sure you want to duplicate this record?')">
                                                            <i class="bx bx-copy me-1"></i> Duplicate taxi
                                                        </a>
                                                    </div>
                                                </div>
                                            </td>
