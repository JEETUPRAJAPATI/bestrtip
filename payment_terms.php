        ...
        <div class="card-box">
            ...
            <div class="p-4">
                ...
                <div class="terms-text">
                    Saser Scenic Pangong is a pure vegetarian retreat, thoughtfully designed to offer a peaceful and
                    comfortable stay amidst the breathtaking beauty of Pangong. Non-vegetarian meals may also be
                    arranged on special request at the time of booking.

                    Guests can enjoy geyser-based hot water shower facility, with up to 25 litres of hot water provided.
                    While we always try our best to offer hot water 24 hours, owing to the extreme weather conditions in
                    the region, morning hot shower availability may remain limited until the end of April. Hot shower
                    service is generally available till 12:00 AM. Whenever required, our team will be happy to arrange
                    an alternative hot water bucket service for your comfort.

                    The property is equipped with 24-hour emergency power backup, along with central dual AC heating
                    from 4:00 PM to 9:30 AM, and electric blankets in all rooms to ensure a warm and pleasant stay.

                    Please note that stargazing experiences are subject to weather conditions and clear sky visibility.

                    The booking amount is non-refundable for cancellations made within 15 days prior to the check-in
                    date.

                    For cancellations due to medical reasons, a valid doctor's prescription or medical report issued by
                    Leh Hospital must be provided for review.

                    Guests are requested to kindly contact our property staff, Mr. Sammer, at least 1 hour prior to
                    arrival, so that the room can be prepared and kept ready for check-in.

                    Acceptance Note
                    I hereby confirm that I have read, understood, and accepted the above terms and conditions, and I
                    confirm my booking by paying the token amount.
                </div>
                            ...
                            <div class="bank-box h-100">
                                <div class="payment-summary-box">
                                    <div class="payment-summary-row">
                                        ...
                                        <strong style="color:#198754;">&#8377;<?= number_format($tokenAmountValue, 2) ?>
                                            (<?= number_format($tokenPercent, 2) ?>%)</strong>
                                    </div>
                                </div>
    ...
    <div id="thank_you_fullscreen" class="thank-you-fullscreen">
        <div class="thank-you-card">
            ...
            <?php if (!empty($booking['booking_token'])): ?>
                <p class="mb-1"><strong>Token Amount:</strong>
                    &#8377;<?= number_format((float) $booking['booking_token'], 2) ?></p>
            <?php endif; ?>
            ...
            <div class="thank-actions">
                ...
                <?php if (!empty($bookingRef)): ?>
                    <a class="btn-invoice"
                        href="download_property_booking_invoice.php?crm=<?= urlencode($_GET['crm'] ?? '') ?>">Download
                        Invoice (PDF)</a>
                <?php endif; ?>
            </div>
        </div>
